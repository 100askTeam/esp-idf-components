 ...
 *      DEFINES
 *********************/
#define SPI_SD_CARD_100ASK_MOUNT_POINT        CONFIG_SPI_SD_CARD_100ASK_MOUNT_POINT
...
bool sdspi_100ask_init(sdspi_100ask_driver_t *driver)
{
    ...
    ret = esp_vfs_fat_sdspi_mount(SPI_SD_CARD_100ASK_MOUNT_POINT, &host, &slot_config, &mount_config, &card);
...
void sdspi_100ask_unmount(void)
{
    ...
    esp_vfs_fat_sdcard_unmount(SPI_SD_CARD_100ASK_MOUNT_POINT, card);
