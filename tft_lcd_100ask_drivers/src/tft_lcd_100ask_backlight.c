...
tft_lcd_100ask_backlight_h tft_lcd_100ask_backlight_new(const tft_lcd_100ask_backlight_config_t *config)
{
    ...
    tft_lcd_100ask_backlight_t *bckl_dev = calloc(1, sizeof(tft_lcd_100ask_backlight_t));
    if (bckl_dev == NULL){
    ...
    return (tft_lcd_100ask_backlight_h)bckl_dev;
}
...
void tft_lcd_100ask_backlight_set(tft_lcd_100ask_backlight_h bckl, int brightness_percent)
{
    ...
    tft_lcd_100ask_backlight_t *bckl_dev = (tft_lcd_100ask_backlight_t *) bckl;
